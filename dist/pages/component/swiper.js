...
var banner1 = "/source/img/banner1.gif";
...
var _App = (_temp2 = _class = function (_BaseComponent) {
  ...
  function _App() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _App.__proto__ || Object.getPrototypeOf(_App)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["banner1"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
