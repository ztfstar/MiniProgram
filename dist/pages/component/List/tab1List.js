...
var Tab1List = (_temp2 = _class = function (_BaseComponent) {
  ...
  function Tab1List() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tab1List.__proto__ || Object.getPrototypeOf(Tab1List)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = [], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
